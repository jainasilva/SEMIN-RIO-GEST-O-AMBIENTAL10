...
TITULOS_SLIDES_GALERIA = {
    ...
    2: "Introdução",
    3: "Política Ambiental e Programas Ambientais",
    4: "Caracterização da Empresa",
    5: "Gestão de Resíduos Industriais",
    6: "Tratamento de Água e Efluentes",
    7: "Gestão dos Recursos Hídricos",
    8: "Gestão de Água, Efluentes e Resíduos",
    9: "Captação Hídrica",
    ...
    20: "Plano de Ação / Cronograma",
    21: "Cronograma de Execução dos Passivos",
    22: "Relatório 2025 - Clima e Carbono",
    23: "Perfil Territorial e Operações",
    24: "Distribuição de Áreas e Localidades",
...
def titulo_galeria(slide: dict) -> str:
    ...
    titulo_padrao = TITULOS_SLIDES_GALERIA.get(numero or -1, "")
...
def pontos_galeria(slide: dict, titulo: str, limite: int = 8) -> list[str]:
    ...
    if pontos:
        return pontos
    return DESCRICOES_SLIDES_GALERIA.get(numero or -1, [])[:limite]
